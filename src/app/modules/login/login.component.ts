...
@Component({
  selector: 'app-login',
  standalone: true,
  imports: [FormsModule, ReactiveFormsModule, CommonModule, MaterialModule, MatProgressSpinnerModule],
...
export class LoginComponent {
  ...
  onSubmit(): void {
    ...
    this.authService.login(creds).pipe(finalize(() => this.isSubmitting = false)).subscribe({
      next: res => {
